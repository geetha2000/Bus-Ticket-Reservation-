...
<body>
<center>
<div class="w3-content w3-section" style="max-width:1000px  max-height:50px">
...
<div class="wrapper">
        <marquee behaviour="alernate"><span class="marquee"><b> Registration into our website is mandatory for booking tickets</b></span></marquee>
        </div>
    <div id="main-wrapper">
