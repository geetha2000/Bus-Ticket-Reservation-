    ...
    <div id="main">
        ...
        <form class="myform"action ="register.php" method="post">
           ...
           <br> &#160;&#160; &#160;&#160;<label><b>EMAIL:</label>
            ...
            &#160;&#160;&#160;<input name="phone" type="integer" class="inputvalues" placeholder="Enter your phone no." required maxlength="10"/><br>
        ...
        if(isset($_POST['submit_btn']))
        {
              ...
              if($password==$cpassword){
                ...
                else
                {
                    ...
                    if($query_run==TRUE )
                    {
                        $query1 ="INSERT INTO address ( pincode , postaladdress , city , state )  VALUES ( '$pincode' , '$postaladdress' , '$city' , '$state' );";
                   ...
                   {                 echo "Error: " . mysqli_error($con);
                        ...
                        echo '<script type ="text/javascript"> alert("User  not added successfuly ....") </script>';
                   }
                }    
